...
<c:set var="url" value="http://localhost:8080/SSO_war_exploded/pages/400.jsp?language=" scope="page" />
...
<div id="holder">
    <header>
        <nav class="navbar-expand-md sticky-top "
            ...
            <div class="container-fluid"><img src="/SSO_war_exploded/assets/img/error.jpg"
        ...
        <div style="position: relative; text-align: center;width: 100%;">
            ...
            <div style="position: absolute; top: 40%; left: 40%;color: white;width: 60%;">
                <h3 class="scaled"
                    ...
                    <fmt message><fmt:message key="Errore_400"/><br> <fmt:message key="Richiesta_Errata"/></fmt>
                </h3>
