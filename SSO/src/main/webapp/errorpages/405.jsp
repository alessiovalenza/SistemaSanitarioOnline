...
<head>
    <title> <fmt:message key="Errore_405"/></title>
        ...
        <div style="position: relative; text-align: center;width: 100%;">
            ...
            <div style="position: absolute; top: 40%; left: 40%;color: white;width: 60%;">
                <h3 class="scaled"
                    ...
                    <fmt message><fmt:message key="Errore_405"/><br> <fmt:message key="Metodo_non_permesso"/>
                        <br><fmt:message key="su_questa_risorsa"/></fmt>
                </h3>
