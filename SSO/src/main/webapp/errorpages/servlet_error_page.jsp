...
<c:set var="url" value="http://localhost:8080/SSO_war_exploded/pages/serlvet_error_page.jsp?language=" scope="page" />
        ...
        <div style="position: relative; text-align: center;width: 100%;">
            ...
            <div style="position: absolute; top: 40%; left: 40%;color: white;width: 60%;">
                <h3 class="scaled"
                    ...
                    <fmt message><%= exc.getStatusErrorCode()%><br><%=exc.getMessage()%></fmt>
                </h3>
