...
<c:set var="url" value="${baseUrl}/errorpages/500.jsp?language=" scope="page" />
...
<div id="holder">
    <header>
        <nav class="navbar-expand-md sticky-top "
            ...
            <div class="container-fluid"><img src="${baseUrl}/assets/img/logoebbasta.png"
        ...
        <div style="position: relative; text-align: center;width: 100%;">
            ...
            <div style="position: absolute; top: 40%; left: 40%;color: white;width: 60%;">
                <h3 class="scaled"
                    ...
                    <fmt message><fmt:message key="Errore_500"/> <br> <fmt:message key="Errore_server"/></fmt>
                </h3>
