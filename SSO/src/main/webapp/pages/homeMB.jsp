    ...
    <div class="wrapper">
        ...
        <div id="content">
                                ...
                                <div class="card-body">
                                    <div style="clear: both">
                                        <form action="#" id="formUploadFoto" method="POST" role="form" enctype="multipart/form-data">
                                            <div class="row">
                                                <input style="/*float: left;*/  width: auto" class="btn btn-primary float-right" type="file" id="fotoToUpload" name="foto"
            ...
            <div id="schedaPaz" class="tool component  container-fluid" >
                ...
                <div id="schedaPaziente" class="container-fluid" style="padding-left: 0;padding-right: 0">
                    <div class="text-center">
