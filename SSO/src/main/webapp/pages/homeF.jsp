                ...
                ajax: {
                    ...
                    processResults: function (data) {
                        ...
                        $.each(data, function (index, item) {
                            myResults.push({
                                'id': item.id,
                                'text': item.farmaco.nome+" "+item.farmaco.descrizione +", ><fmt:message key='prescritta da'/> "+item.medicoBase.nome+" "+item.medicoBase.cognome+" ><fmt:message key='il'/> "+item.emissione
                            });
                        });
                        return {
                            results: myResults
